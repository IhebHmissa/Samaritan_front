...
export const reducers = combineReducers({
  ...
  requests: require('../../modules/entities/request/request.reducer').reducer,
  reclReps: require('../../modules/entities/recl-rep/recl-rep.reducer').reducer,
  notifications: require('../../modules/entities/notification/notification.reducer').reducer,
  historyLines: require('../../modules/entities/history-line/history-line.reducer').reducer,
