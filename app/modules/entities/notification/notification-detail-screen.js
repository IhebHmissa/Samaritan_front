...
function NotificationDetailScreen(props) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.paddedScrollView} testID="notificationDetailScrollView">
      ...
      <Text testID="timestamp">{String(notification.timestamp)}</Text>
      {/* Lieu Field */}
      <Text style={styles.label}>Lieu:</Text>
      <Text testID="lieu">{notification.lieu}</Text>
      {/* Timewindow2 Field */}
      <Text style={styles.label}>Timewindow2:</Text>
      <Text testID="timewindow2">{notification.timewindow2}</Text>
